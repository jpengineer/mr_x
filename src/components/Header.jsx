    ...
    return (
        <header
            ...
            <div
                ...
                <div className={`${isMobile ? "-ml-5 text-4xl" : ""} leading-none text-2xl md:text-2xl lg:text-8xl lg:-mb-5 lg:-ml-6 md:mb-2 md:ml-1 -rotate-12 font-black bg-transparent`}>Mr.</div>
                <div
                    className="text-[90px] sm:text-[140px] md:text-[100px] lg:text-[300px] font-black -rotate-12 -mt-4 sm:-mt-6 sm:ml-4 bg-transparent">X
                </div>
            </div>
